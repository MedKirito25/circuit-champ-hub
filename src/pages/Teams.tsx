...
import { Bot, Users, Filter, Search } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  {teams.length} teams competing across all categories
                </p>
              </div>
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="glass-card p-12 text-center">
              ...
              <h3 className="font-display font-bold text-xl mb-2">No Teams Found</h3>
              <p className="text-muted-foreground">
                {searchQuery
